...
<html lang="en">
    <head>
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <title>Passenger Login | Masar Bus System</title>
        <!-- Bootstrap CSS -->
        ...
        <div class="login-container">
            ...
            <div class="login-card" data-aos="zoom-in">
                <div class="card-header">
                    <h3>
                        <i class="fas fa-user-circle me-2"></i>Welcome to Masar
                    </h3>
                ...
                <div class="card-body">
                    <form action="LoginServlet" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="footer-links">
                            <p class="mb-2">Don't have an account? <a href="register.jsp">Register here</a></p>
                            <p class="mb-0"><a href="index.html"><i class="fas fa-arrow-left me-1"></i>Back to Home</a></p>
                        </div>
                    </form>
                </div>
            </div>
